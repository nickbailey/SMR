...
The above example specifies the width of figure as half that of the text.
Here's an example illustrating a few other attributes you can use when importing graphics:
\begin{figure}
